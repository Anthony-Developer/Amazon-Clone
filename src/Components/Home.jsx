        ...
        <div className="home">
            ...
            <div className="home_container">
                ...
                <div className="home_row">
                    <Product id="01" title='The Lean Startup: How Constant Innovation Creates Radically Successful Businesses' price={12.99} image="https://images-na.ssl-images-amazon.com/images/I/51Zymoq7UnL._AC_SY400_.jpg" rating={3} />
